...
class Create_question_window_2(QMainWindow, Ui_Create_question_window):
    ...
    def submit_answer(self):
        ...
        file_name = os.path.join(save_directory, f"subjective_{timestamp}.json")
        ...
        if self.selected_image_path:
            image_name = f"image_subjective_{timestamp}" + os.path.splitext(self.selected_image_path)[1]
